      ...
      <Wrapper className="p-4">
        <div className="font-medium text-muted-foreground">
          ...
          <p className="my-6 sm:text-center">
            Looking for the best wedding planner in Jaipur and India? Then look
            no more. Fiestro Events is one of the top 10 wedding planner in
            ...
            planners in Jaipur will help you enjoy the event and let all the
            ...
            reasonable Wedding planner cost for Jaipur wedding.{" "}
          </p>
          ...
          <p className="sm:text-center">
            ...
            Jaipur, India. We take care of all your wishes and the comfort of
            your family and friends so that you can have the best time of your
            life.{" "}
          </p>
        </div>
